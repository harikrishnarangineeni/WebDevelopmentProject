...
function Validation() {
	...
	var x= document.f1.id.value;
	var y= document.f1.password.value;
	if(x=="") {
		alert("enter userid");
		return false;
	}
                            ...
                            <div class="form-bottom">
			                    <form name="f1" action="<%=request.getContextPath()%>/PurchaseSBTController" method="post" class="login-form"> 
			                    	<div class="form-group">
			                        	...
			                        	<input type="number" name="id" id="uid" placeholder="UserID..." class="form-username form-control">
			                        </div>
			                        <div class="form-group">
			                        	<label class="sr-only" for="form-password">Password</label>
			                        	<input type="password" name="password" id="pword" placeholder="Password..." class="form-password form-control">
			                        </div>
			                        <button type="submit" value="submit" onclick="return Validation()" class="btn">Sign in</button>
